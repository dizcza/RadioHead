...
/////////////////////////////////////////////////////////////////////
/// \class RH_RHF76 RH_RHF76.h <RH_RHF76.h>
/// \brief Driver to send and receive unaddressed, unreliable datagrams via 
/// radio transceiver in a RHF76-52 module, which includes an STM32L051 processor,
...
private:
    ...
    static RH_RHF76* _thisDevice;

};

/// @example rhf76_client.pde
/// @example rhf76_server.pde
